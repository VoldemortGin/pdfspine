...
> references ONLY; no reference output is ever committed — only similarity scores. oxide-pdf is
...
and reading order.** On reading order specifically, oxide matches or exceeds fitz on **13/58**
documents. The three production-grade engines (oxide / fitz / pypdfium2) cluster within ~1–2pp;
...
oxide-pdf is at parity with fitz and pypdfium2 here (jaccard and f1 identical); pdfminer reads these row-major
