...
Published v0.9.1 (`e34de546181e35cbfb334f122065e22de59cb70d`) is
...
- [x] **`Font` (22/23)** — metrics object (`text_length`/`char_lengths`/`glyph_advance`/`has_glyph`/
  ...
  is out-of-scope.
- [x] **`Tools` / `TOOLS` (15/22)** — diagnostics/tuning singleton headline paths landed (incl.
  `image_profile`, `set_annot_stem` and dynamic `set_subset_fontnames`);
