# mypy: ignore-errors
"""Canonical Table Transformer structure post-processing.

Adapted from Microsoft Table Transformer ``src/postprocess.py`` at commit
``16d124f616109746b7785f03085100f1f6247575``.
Copyright (C) 2021 Microsoft Corporation. Licensed under the MIT License.
Adaptations replace the geometry import and make two standalone error paths
explicit; the table canonicalization algorithm is otherwise unchanged.
"""
