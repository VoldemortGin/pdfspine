...
pub use serialize::{
    ...
    to_dict, to_dict_with_images, to_html, to_json, to_json_with_images, to_text, to_words,
    to_xhtml, to_xml, BlockTuple, DictBlock, DictBlockRef, DictChar, DictImageBlock, DictLine,
    DictSpan, DictTextBlock, ImageResolver, ResolvedImage, TextDict, WordTuple,
};
