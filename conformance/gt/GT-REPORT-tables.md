...
- Tables detected: oxide **200**, fitz **170** (ratio oxide/fitz = 1.18)
- **Table-count agreement** (per-page #oxide==#fitz): **97.7%** (1545/1581 pages)
- Tables matched by IoU>0.5: **73** (= 36% of oxide, 43% of fitz tables)
...
- **irs-f8949.pdf** — ox 2 / fz 4 tables, shape 0%, cellF1 0.584 → _oxide under-segments: 2 vs fitz 4 tables (merges/misses)_
- **irs-f1040sb.pdf** — ox 1 / fz 2 tables, shape —, cellF1 — → _oxide under-segments: 1 vs fitz 2 tables (merges/misses)_
- **irs-f1040sc.pdf** — ox 1 / fz 5 tables, shape —, cellF1 — → _oxide under-segments: 1 vs fitz 5 tables (merges/misses)_
- **irs-fw7.pdf** — ox 9 / fz 2 tables, shape —, cellF1 — → _oxide over-segments: 9 vs fitz 2 tables (splits/spurious)_
- **irs-f1040.pdf** — ox 10 / fz 7 tables, shape 67%, cellF1 0.818 → _oxide over-segments: 10 vs fitz 7 tables (splits/spurious)_
- **irs-f1120.pdf** — ox 14 / fz 7 tables, shape 0%, cellF1 0.535 → _oxide over-segments: 14 vs fitz 7 tables (splits/spurious)_
- **irs-f941.pdf** — ox 3 / fz 3 tables, shape —, cellF1 — → _minor / mixed divergence_
- **irs-f8843.pdf** — ox 0 / fz 6 tables, shape —, cellF1 — → _oxide finds NO tables where fitz does (detection miss)_

## Verdict

**Strong parity.** oxide's `find_tables` largely agrees with fitz on count, grid shape, and cell text.
- Table counts are broadly comparable (200 oxide / 170 fitz).
