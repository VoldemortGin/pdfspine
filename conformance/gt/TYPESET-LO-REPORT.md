...
*Generated 2026-07-03T00:57:37+0800 · soffice: `/Applications/LibreOffice.app/Contents/MacOS/soffice` · dpi 100.0 · advisory band **0.80–0.90** (local-only — LibreOffice is NOT a CI dependency).*
...
| pptx | `fixtures/typeset/typeset-lo-slide.pdf` | `sample-slide.pdf` | 0.9228 | above-band |
